...
public class MRC402TransferFragment extends DappCallFragment<Mrc402transferFragmentBinding> {
    @Override
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.btnAction.setOnClickListener(v -> {
            Intent intent = getDeepLinkIntent(binding.common, "mrc402Transfer");

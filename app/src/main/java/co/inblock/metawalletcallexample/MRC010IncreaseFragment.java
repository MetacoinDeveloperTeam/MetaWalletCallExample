...
import co.inblock.metawalletcallexample.databinding.Mrc010increaseFragmentBinding;

public class MRC010IncreaseFragment extends DappCallFragment<Mrc010increaseFragmentBinding> {

    @Override
    public View onCreateView(
            @NonNull LayoutInflater inflater, ViewGroup container,
            Bundle savedInstanceState) {
        binding = Mrc010increaseFragmentBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.btnAction.setOnClickListener(v -> {
            Intent intent = getDeepLinkIntent(binding.common, "tokenIncrease");
